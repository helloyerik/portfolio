...
const ecommerceWorkflowSections = [
  {
...
const partnersWorkflowSections = [
  {
    title: "Что это за слой",
    paragraphs: [
  ...
  },
  {
    ...
    list: [
      "brainstorm с менеджером, аналитиком, backend и frontend",
      "опрос категорийных менеджеров",
      "поиск аналогий и референсов для внутренних интерфейсов",
      "разложение процесса на последовательные этапы",
    ],
  },
  {
    title: "Как рождалась структура решения",
    paragraphs: [
      "Ключевой эвристикой стало понимание, что этот процесс ближе к работе с входящими сообщениями, чем к обычному catalog UI. Из большого потока нужно быстро выделять ценные предложения, сохранять их, сравнивать и переводить дальше по процессу.",
      "Это помогло не копировать структуру 1С, а выстроить собственную логику интерфейса.",
    ],
  },
  {
    title: "Какие компромиссы были важны",
    paragraphs: [
      "Проект нужно было довести до MVP быстро, поэтому часть решений приходилось строить на reuse уже существующих компонентов и знакомых паттернов. Это было осознанным выбором: сначала дать устойчивый рабочий каркас, а потом наращивать глубину.",
    ],
    list: [
...
function WorkflowPage({ title, publicHref, sections }) {
  return (
    <main className="page case-page shell">
      <div className="content-block">
...
function EcommerceWorkflowPage() {
  return (
    <WorkflowPage
      ...
      sections={ecommerceWorkflowSections}
    />
  );
}
...
function PartnersWorkflowPage() {
  return (
    <WorkflowPage
      ...
      sections={partnersWorkflowSections}
    />
  );
}
